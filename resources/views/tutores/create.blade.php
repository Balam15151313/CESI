    ...
    <form action="{{ route('tutores.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6"> 
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('tutor_nombre') is-invalid @enderror" id="tutor_nombre" name="tutor_nombre" value="{{ old('tutor_nombre') }}" required placeholder="Ingresa el nombre completo">
                        @error('tutor_nombre')
            ...
            <div class="col-md-6"> 
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control @error('tutor_telefono') is-invalid @enderror" id="tutor_telefono" name="tutor_telefono" value="{{ old('tutor_telefono') }}" required placeholder="Ingresa el teléfono">
            ...
            <div class="col-md-6"> 
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control @error('tutor_usuario') is-invalid @enderror" id="tutor_usuario" name="tutor_usuario" value="{{ old('tutor_usuario') }}" required placeholder="Ingresa el correo electrónico">
                        @error('tutor_usuario')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="col-md-6"> 
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control @error('tutor_contraseña') is-invalid @enderror" id="tutor_contraseña" name="tutor_contraseña" required placeholder="Ingresa la contraseña">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="file" class="form-control @error('tutor_foto') is-invalid @enderror" id="tutor_foto" name="tutor_foto" required accept="image/*">
                @error('tutor_foto')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
