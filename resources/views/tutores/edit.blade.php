    ...
    <form action="{{ route('tutores.update', $tutor->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control @error('tutor_nombre') is-invalid @enderror" id="tutor_nombre" name="tutor_nombre" value="{{ old('tutor_nombre', $tutor->tutor_nombre) }}" required placeholder="Ingresa el nombre completo">
                        @error('tutor_nombre')
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control @error('tutor_telefono') is-invalid @enderror" id="tutor_telefono" name="tutor_telefono" value="{{ old('tutor_telefono', $tutor->tutor_telefono) }}" required placeholder="Ingresa el teléfono">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control @error('tutor_usuario') is-invalid @enderror" id="tutor_usuario" name="tutor_usuario" value="{{ old('tutor_usuario', $tutor->tutor_usuario) }}" required placeholder="Ingresa el correo electrónico">
                        @error('tutor_usuario')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control @error('tutor_contraseña') is-invalid @enderror" id="tutor_contraseña" name="tutor_contraseña" placeholder="Ingresa la nueva contraseña">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <select class="form-select @error('cesi_escuela_id') is-invalid @enderror" id="cesi_escuela_id" name="cesi_escuela_id" required>
                    <option value="">Selecciona una escuela</option>
                    @foreach ($escuelas as $escuela)
                        <option value="{{ $escuela->id }}" {{ old('cesi_escuela_id', $tutor->cesi_escuela_id) == $escuela->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="file" class="form-control @error('tutor_foto') is-invalid @enderror" id="tutor_foto" name="tutor_foto" accept="image/*"> 
                @error('tutor_foto')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
